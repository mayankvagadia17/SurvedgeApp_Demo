...
@Composable
fun StakeoutSheet(
    state: MappingSheetState.Stakeout,
    onDismiss: () -> Unit
) {
    ...
    ModalBottomSheet(
        ...
        Column(
            ...
            Row(
                ...
                Text("Stakeout", style = MaterialTheme.typography.headlineSmall)
                Spacer(modifier = Modifier.weight(1f))
            ...
            Text("Target: ${state.targetPoint?.id ?: "None"}", style = MaterialTheme.typography.bodyMedium)
